...
import com.example.mymovieskotlin.model.repository.MoviesDBRepository
import com.example.mymovieskotlin.model.repository.MoviesDBRepositoryImpl
    ...
    fun getMovieDetails(id: Int) {
        ...
        response.enqueue( object : Callback<MovieDetails> {
            ...
            override fun onFailure(call: Call<MovieDetails>, t: Throwable) {
                Log.d("getMovieDetails", "onFailure")
            }
        })
    }
}